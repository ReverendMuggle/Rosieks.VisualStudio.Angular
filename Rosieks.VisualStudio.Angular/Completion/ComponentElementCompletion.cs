namespace Rosieks.VisualStudio.Angular.Completion
{
    ...
    public class ComponentElementCompletion : IHtmlCompletionListProvider
    {
        ...
        public IList<HtmlCompletion> GetEntries(HtmlCompletionContext context)
        {
            ...
            return ngHierarchy.Components.Value
                .Where(d => d.Restrict.HasFlag(NgComponentRestrict.Element))
                .Select(
